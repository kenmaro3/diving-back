...
export class UpdateSpotDto{
    ...
    @IsString({message: 'is_image1_updated must be string'})
    readonly is_image1_updated: string;

    @IsString({message: 'is_image2_updated must be string'})
    readonly is_image2_updated: string;

    @IsString({message: 'is_image3_updated must be string'})
    readonly is_image3_updated: string;

    @IsString({message: 'is_image4_updated must be string'})
    readonly is_image4_updated: string;

    @IsString({message: 'is_image5_updated must be string'})
    readonly is_image5_updated: string;

    @IsString({message: 'is_image6_updated must be string'})
    readonly is_image6_updated: string;
